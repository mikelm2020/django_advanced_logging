"""
Configuración base común para todos los ambientes.
"""
...
MIDDLEWARE = [
    ...
    # django-advanced-logging middlewares
...
# ============================================================================
# DJANGO-ADVANCED-LOGGING BASE CONFIGURATION
# ============================================================================
# La configuración específica se hace en cada ambiente
# Aquí solo definimos la estructura base
LOGGING_CONFIG = {
    'name': os.getenv('LOG_NAME', 'django_app'),
    'mask_sensitive': True,  # Siempre enmascarar datos sensibles
}
